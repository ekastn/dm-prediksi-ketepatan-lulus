...
```python
# Load clean dataset
DATA_DIR = '.'  # experiment: global median imputation
...
```
    ...
    =======================================================
     ...
     Tidak Tepat       1.00      0.06      0.11        54
     Tepat Waktu       0.78      1.00      0.87       177
    
        accuracy                           0.78       231
       macro avg       0.89      0.53      0.49       231
    weighted avg       0.83      0.78      0.69       231
    ...
    Test     | Acc=0.7792 | Prec(0)=1.0000 | Recall(0)=0.0556 | F1(0)=0.1053 | AUC=0.5278
...
![png](01-temporal-results_files/01-temporal-results_7_0.png)
...
```
    ...
    ──────────────────────────────────────────────────
    accuracy        1.0000       0.9524       +0.0476     
    recall          1.0000       0.9696       +0.0304     
    f1              1.0000       0.9749       +0.0251     
...
![png](01-temporal-results_files/01-temporal-results_9_1.png)
...
```
    ...
    Features with ZERO importance (3):
      - program
      - sks_sem3
      - failed_in_sem1
...
![png](01-temporal-results_files/01-temporal-results_11_0.png)
...
```
    ...
    ────────────────────────────────────────────────────────────
    accuracy           1.0000       0.9524                   
    precision          1.0000       0.9806                   
    recall             1.0000       0.9696                   
    f1                 1.0000       0.9749                   
    roc_auc            1.0000       0.7598                   
    ────────────────────────────────────────────────────────────
    Overfitting check  : Train F1 - CV F1 = 0.0251
    ────────────────────────────────────────────────────────────
